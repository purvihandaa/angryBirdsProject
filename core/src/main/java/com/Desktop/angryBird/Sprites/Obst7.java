...
public class Obst7 extends Obstacles {
    ...
    private static final int HIT_THRESHOLD = 4; // Example threshold

    private static final float DENSITY = 0.3f; // Example density
    private static final float RESTITUTION = 0.1f; // Example restitution
    private static final float FRICTION = 0.5f; // Example friction
    ...
    public Obst7(World world, float x, float y, float width, float height) {
        ...
        setTexture(new Texture("obj7.png"));  // Set the texture for this obstacle
    }
